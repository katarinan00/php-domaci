...
<div class="forma" style="margin-top: 50px">
    <form method="post" id="formaRegistracija">
        ...
        <div class="d-grid gap-2 d-md-block">
            <button type="submit" id="registrujSe" class="btn btn-success" style="background-color: rgb(169,169,169); border:none" >Napravi nalog</button>
            <button type="reset" class="btn btn-primary" style="background-color: rgb(119,136,153);border:none" >Resetuj formu</button>
            <button type="button" onclick="document.location.href='index.php'" class="btn btn-danger" style="background-color:rgb(47,79,79);border:none"  >Otkaži</button>
        </div>
