...
$('#sortGBtn').click(function (){
    ...
    while (!sortirano) {
        ...
        for (i = 0; i < objekti.length-1; i++) {
            zaZamenu = false;
            let el1 = objekti[i].getElementsByClassName("card-text karticaGrad")[0];
            let el2 = objekti[i + 1].getElementsByClassName("card-text karticaGrad")[0];
            if (el1.innerHTML.toLowerCase() > el2.innerHTML.toLowerCase()) {
                zaZamenu = true;
                break;
            }
