...
<div class="header">
    ...
    <div class="navigacija d-flex justify-content-between">
        <ul class="nav" id="navigacija-lista" >
            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="pocetna.php">Pocetna</a>
            </li>
            <li class="nav-item">
...
<div class="content">
    ...
    <form method="post" id="formaRegistracija">
            ...
            <div class="d-grid gap-2 d-md-block">
                <button type="submit"  class="btn btn-success" style="background-color: rgb(119,136,153);border:none">Izmeni nalog</button>
                <button type="button" id="obrisiNalogBtn" class="btn btn-danger" style="background-color:rgb(47,79,79);border:none" >Obrisi nalog</button>
            </div>
